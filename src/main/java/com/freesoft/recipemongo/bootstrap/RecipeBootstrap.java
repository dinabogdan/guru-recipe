package com.freesoft.recipemongo.bootstrap;

import com.freesoft.recipe.enumz.Difficulty;
import com.freesoft.recipemongo.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitMeasure> tableSpoonUomOptional = unitMeasureRepository.findByDescription("Tablespoon");
        if (!tableSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not found");
        }

        Optional<UnitMeasure> teaSpoonUomOptional = unitMeasureRepository.findByDescription("Teaspoon");
        if (!teaSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not found");
        }

        Optional<UnitMeasure> dashUomOptional = unitMeasureRepository.findByDescription("Dash");
        if (!dashUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not found");
        }

        Optional<UnitMeasure> pintUomOptional = unitMeasureRepository.findByDescription("Pint");
        if (!pintUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not found");
        }

        Optional<UnitMeasure> cupsUomOptional = unitMeasureRepository.findByDescription("Cup");
        if (!cupsUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not found");
        }

        UnitMeasure eachUom = eachUomOptional.get();
        UnitMeasure tableSpoonUom = tableSpoonUomOptional.get();
        UnitMeasure teaSpoonUom = teaSpoonUomOptional.get();
        UnitMeasure dashUom = dashUomOptional.get();
        UnitMeasure pintUom = pintUomOptional.get();
        UnitMeasure cupsUom = cupsUomOptional.get();
